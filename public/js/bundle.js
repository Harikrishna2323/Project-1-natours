...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFyaWtiIiwiYSI6ImNrdWJieDM5aDBtdHAydW12dGRvNjEwb2gifQ.b2R1TEYBajxcJIuXMYiQqg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //Adding a popup
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JjJL1SF3eG66OdBY6uMWJ7r6cXlRVni6l1UfBi3xdhSARZr2lkG6qZquKi3mehqJhuYyzwyTLGVCrTWrqvOoQ5k00VjWEVoZN'); // 1) Get checkout session from API
          ...
          case 4:
            ...
            console.log('session', session); // 2) Create checkout form + chanre credit card
